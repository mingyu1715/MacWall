...
@interface MacWallLockScreenSaverView : ScreenSaverView
...
@implementation MacWallLockScreenSaverView
...
- (NSDictionary *)readConfiguration {
    ...
    NSURL *configurationURL = [[[applicationSupport URLByAppendingPathComponent:@"MacWall"]
