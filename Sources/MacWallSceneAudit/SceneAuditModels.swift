...
public enum SceneAuditFeatureSupport:
    String,
    Codable,
    Equatable,
    Sendable
...
public enum SceneAuditFeatureKey:
    String,
    Codable,
    CaseIterable,
    Equatable,
...
public struct SceneAuditFeatureObservation:
    Codable,
    Equatable,
    Sendable
{
...
public struct SceneAuditPackageSummary:
    Codable,
    Equatable,
    Sendable
{
...
public enum SceneAuditDependencyResolution:
    String,
    Codable,
    Equatable,
    Sendable
...
public struct SceneAuditDependency:
    Codable,
    Equatable,
    Sendable
{
...
public enum SceneAuditDiagnosticSeverity:
    String,
    Codable,
    Equatable,
    Sendable
...
public struct SceneAuditDiagnostic:
    Codable,
    Equatable,
    Sendable
{
...
public enum SceneAuditTextureStatus:
    String,
    Codable,
    Equatable,
    Sendable
...
public struct SceneAuditTextureSummary:
    Codable,
    Equatable,
    Sendable
{
    ...
    public init(
        ...
        self.trailingByteCount = trailingByteCount
    }
}
...
public struct SceneAuditReport: Codable, Equatable, Sendable {
    ...
    public init(
        ...
        self.canvas = canvas
        self.entryKinds = entryKinds.sorted {
            $0.name < $1.name
        }
        self.objectKinds = objectKinds.sorted {
            $0.name < $1.name
        }
        ...
        self.scriptHandlers = scriptHandlers.sorted {
            $0.name < $1.name
        }
