...
struct MacWallWallpaperExtensionConfiguration: AppExtensionConfiguration {
    func accept(connection: NSXPCConnection) -> Bool {
        macWallNativeWallpaperLogger.info(
            "Accepting WallpaperAgent XPC connection wallpaperAgentPid=\(connection.processIdentifier)"
        )
        ...
        connection.invalidationHandler = {
            ...
            macWallNativeWallpaperLogger.warning(
                "WallpaperAgent XPC connection invalidated removedContexts=\(removed)"
            )
        }
